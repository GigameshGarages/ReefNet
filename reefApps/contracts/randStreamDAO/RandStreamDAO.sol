...
address public BeaconContractAddress=0x79474439753C7c70011C3b00e06e559378bAD040;
    ...
    function newCampaign(
        ...
        c.StreamGroups[msg.sender] = StreamNetwork(msg.sender, msg.value);
    ...
    function follow(uint256 _campaignID)
        ...
        Campaign storage c = campaigns[_campaignID];
        StreamNetwork storage StreamNode = c.StreamGroups[msg.sender];
        return followCampaign(_campaignID, c, StreamNode);
    }
    ...
    function followCampaign(
        uint256 _campaignID,
        Campaign storage c,
        StreamNetwork storage FractalNode
